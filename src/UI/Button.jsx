const Button = ({
  ...
  const getButtonVariation = (variation) => {
    switch (variation) {
      case "primary":
        return "bg-[#0E556C] text-white hover:bg-[#398097] hover:text-white active:bg-[#06222B] border border-[#4D4D2D] rounded-lg transition-colors font-regular";
      case "secondary":
        return "bg-transparent text-[#0B4457] border-2 border-[#0E556C] hover:bg-[#CFE0E6] hover:text-[#116682] hover:opacity-50 font-regular";
      case "tertiary":
